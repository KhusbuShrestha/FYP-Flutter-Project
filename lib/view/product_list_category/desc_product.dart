...
class DescProductPage extends StatelessWidget {
  const DescProductPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    print('ata');
    print(desc.descProducts.value.data);
    return Scaffold(
      appBar: AppBar(
      ...
      body: Obx(
        () => desc.loading.value
            ...
            : desc.descProducts.value.data.isEmpty
                ? const Center(
                            ...
                            Expanded(
                              ...
                              child: DropdownButton<String>(
                                ...
                                onChanged: (value) {
                                  ...
                                  // if (value == "Desc") {
                                  //   desc.getOrderDesc(globals.category_id);
                      ...
                      child: InkWell(
                        ...
                        Padding(
                          ...
                          child: GridView.builder(
                              ...
                              shrinkWrap: true,
                              itemCount: desc.descProducts.value.data.length,
                              itemBuilder: (BuildContext context, int index) {
                                var mydata =
                                    desc.descProducts.value.data[index];
                                return InkWell(
                                  onTap: () {
