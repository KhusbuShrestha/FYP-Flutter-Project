...
class AscProductPage extends StatelessWidget {
  const AscProductPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Obx(
        () => asc.loading.value
            ...
            : asc.increaseProductList.value.data.isEmpty
                ? const Center(
                      ...
                      child: InkWell(
                        ...
                        Padding(
                          ...
                          child: GridView.builder(
                              ...
                              shrinkWrap: true,
                              itemCount: asc.increaseProductList.value.data.length,
                              itemBuilder: (BuildContext context, int index) {
                                var mydata =
                                    asc.increaseProductList.value.data[index];
                                return InkWell(
                                  onTap: () {
